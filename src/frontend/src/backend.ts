...
export class Backend implements backendInterface {
    ...
    async getCategoryAnalysis(): Promise<CategoryResults> {
        if (this.processError) {
            try {
                const result = await this.actor.getCategoryAnalysis();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentSessions(): Promise<Array<CompletedSession>> {
        if (this.processError) {
            try {
    ...
    async getReconsiderationRate(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getReconsiderationRate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSession(arg0: string, arg1: Array<StageResponse>, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
